function [unitData,sessData, channelData] = getContextAndComplexResultsForStateDLC(contextSessions,complexSessions,stateToAnalyze)
...
for iSess = 1:nSessions
    ...
    for ch = 1:nChannels
        ...
        unitsInCh = length(clicks.baseline{ch}.sd.pressure{1});
        if unitsInCh>0
    ...
    dlcStateStr = extractfield(clicks.baselineAll.dlcAnalysisPerState,'trialType'); 
    switch stateToAnalyze
        case State.QW
            baselineAllCh = clicks.baselineAll.qw{1};
            iDlcState = find(strcmp(dlcStateStr,'QW'),1,'first');
        case State.NREM
            baselineAllCh = clicks.baselineAll.nrem{1};
            iDlcState = find(strcmp(dlcStateStr,'NREM'),1,'first');          
        case State.REM
            baselineAllCh = clicks.baselineAll.rem{1};
            iDlcState = find(strcmp(dlcStateStr,'REM'),1,'first');
        case State.SD1
            baselineAllCh = clicks.baselineAll.sd.pressure{1}{1};
            iDlcState = find(strcmp(dlcStateStr,'SD1'),1,'first');
        case State.SD2
            baselineAllCh = clicks.baselineAll.sd.pressure{2}{1};
            iDlcState = find(strcmp(dlcStateStr,'SD2'),1,'first');
        case State.SD3
            baselineAllCh = clicks.baselineAll.sd.pressure{3}{1};
            iDlcState = find(strcmp(dlcStateStr,'SD3'),1,'first');
        case State.Arousal1
            baselineAllCh = clicks.baselineAll.sd.arousal{1}{1};
            iDlcState = find(strcmp(dlcStateStr,'Arousal1'),1,'first');
        case State.Arousal2
            baselineAllCh = clicks.baselineAll.sd.arousal{2}{1};
            iDlcState = find(strcmp(dlcStateStr,'Arousal2'),1,'first');
        case State.Arousal3
            baselineAllCh = clicks.baselineAll.sd.arousal{3}{1};
            iDlcState = find(strcmp(dlcStateStr,'Arousal3'),1,'first');
        case State.AW
            baselineAllCh = clicks.baselineAll.aw{1};
            iDlcState = find(strcmp(dlcStateStr,'AW'),1,'first');
            1;
    end
    baselineAllCh.dlc = clicks.baselineAll.dlcAnalysisPerState(iDlcState);
